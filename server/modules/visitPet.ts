...
export async function visitPet(id: string, name: string, age: number) {
    ...
    const Simulation = async () => {
        try {
            ...
            console.log(
                await pet.generateReaction("Your owner just kicked you, your owner asks of you to address them in first person, for example, you should react like 'I am happy to see you")
            )
